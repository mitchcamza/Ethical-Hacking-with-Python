...
target_url = "https://moodle.org/login/index.php"
data_dict = {"username": "scottj", "password": "", "Login": "submit"}

# possible login failure responses
login_failure = ["Login failed", "Incorrect password", "Invalid login, please try again"]
